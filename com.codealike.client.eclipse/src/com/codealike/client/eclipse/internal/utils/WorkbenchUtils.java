		...
		new Thread() {
			public void run() {
				Runnable r = new Runnable() {
					...
					public void run() {
						try {
							IWorkbenchSite site = WorkbenchUtils.getActiveWindow().getActivePage().getActivePart()
									.getSite();
							...
							if (WorkbenchUtils.getActiveWindow().getActivePage()
									.findView(CodealikeDashboard.ID) != null) {
								WorkbenchUtils.getActiveWindow().getActivePage().findView(CodealikeDashboard.ID)
